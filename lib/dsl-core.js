...
(function(module) {
  ...
  const dslGlobalObject = { JSON: JSON, Math: Math };
  ...
  function addGlobalObject(key, obj) {
    dslGlobalObject[key] = obj;
  }

  function getLastKeyValue(arg, root = this) {
    const rawArg = arg.toString();
  ...
  dslFunctions.get = function(arg1, ...args) {
    ...
    let defaultValue;
    if (args.length > 0 &&
      typeof args[args.length - 1].toString() !== 'string') {
  ...
  dslFunctions.print = function(...args) {
    ...
    console.log.apply(null, evaluated);
  };
  ...
  dslFunctions.format = function(...args) {
    const _this = this;
    const evaluated = args.map(function(arg) {
      return arg.evaluate(_this);
    });
    let formatString = evaluated.shift();
    argsAssert({
  ...
  dslFunctions.join = function(...args) {
    const _this = this;
  ...
  ['map', 'filter', 'every', 'some', 'forEach'].forEach(function(funcName) {
    dslFunctions[funcName] = function(arg1, arg2, arg3) {
      ...
      const key = arg3 ? arg3.toString() : 'item';
      argsAssert({
  ...
  dslFunctions.reduce = function(arg1, arg2, arg3, arg4, arg5) {
    ...
    const resultKey = arg2.toString();
    const currentKey = arg3.toString();
    argsAssert({
  ...
  dslFunctions.re = function(arg1, arg2) {
    ...
    if (arg2) {
      argsAssert({
        '1st argument': [arg1.toString(), 'string'],
        '2nd argument': [arg2.toString(), 'string']
      }, 're', [arg1, arg2]);
      return new RegExp(arg1.toString(), arg2.toString());
    }
    else {
      argsAssert({
        '1st argument': [arg1.toString(), 'string']
      }, 'format', [arg1, arg2]);
      return new RegExp(arg1.toString());
    }
  };
  ...
  dslFunctions.performance = function(arg) {
    const performanceName = arg.toString();
    if (!this['performance']) {
  ...
  dslFunctions.function = function(arg1, arg2) {
    const _self = this;
    const argumentNames = arg1.evaluate(_self);
    return function(...args) {
  ...
  dslFunctions.alert = function(arg) {
    if (typeof alert === 'function') {
      alert(arg.evaluate(this));
    }
  };
  ...
  dslFunctions['prototype'] = function(arg1, arg2) {
    ...
    const dis = this;
    clazz.prototype[arg1.toString()] = function(...arg) {
  ...
  dslFunctions.testcase = function(arg1, arg2) {
    ...
    const testResult = {
      beforeThis,
      afterThis: this,
      leftRaw: arg1.toString(),
      rightRaw: arg2.toString(),
      hasError: false,
      passed: false
    };
    try {
  ...
  dslFunctions.testsuite = function(arg1, ...args) {
    ...
    for (let arg of args) {
      ...
      if ('testcase' in arg.toString()) {
        ...
        if (!evaluated.passed ||
          evaluated.hasError ||
          arg.toString()['testcase'][2] === 'showAlways') {
      ...
      if (typeof arg === 'string') {
        ...
        if (key in dslFunctions) {
          ...
          return dslFunctions.attr_set.apply(_this, [
            new Argument(key.substr(1)), new Argument(arg[key])
          ]);
        }
        else {
          return arg;
