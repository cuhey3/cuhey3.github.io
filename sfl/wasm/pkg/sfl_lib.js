...
* @returns {any}
*/
export function get_division_matches() {
    const ret = wasm.get_division_matches();
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_sort_44beaf9aa39515ae = function(arg0) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('sfl_lib_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
